...
import { abandonPersonalTrial } from './actions'

export default function AbandonPersonalTrialButton() {
  ...
  function handleConfirm() {
    ...
    startTransition(async () => {
      const result = await abandonPersonalTrial()
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: 14, color: 'var(--muted)', lineHeight: 1.65, marginBottom: 28 }}>
              Ты можешь остановиться без последствий. Испытание сохранится в истории.
            </p>
